...
CREATE DATABASE exam_system_online CHARACTER set utf8mb4 COLLATE utf8mb4_general_ci;
...
-- - utf8mb4_0900_ai_ci 是 MySQL 8.0 及以上版本引入的一种字符集排序规则。
-- - 它是基于 Unicode Collation Algorithm (UCA) 版本 9.0 的一种排序规则，
-- - 其中 ai 表示 accent insensitive（重音不敏感）
